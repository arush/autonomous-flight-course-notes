...
function b(p){for(var v=g,r=0;64>r;r+=4)v[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=v[r-3]^v[r-8]^v[r-14]^v[r-16],v[r]=(p<<1|p>>>31)&4294967295;p=e[0];var B=e[1],K=e[2],na=e[3],Oc=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ja=na^B&(K^na);var Kb=1518500249}else Ja=B^K^na,Kb=1859775393;else 60>r?(Ja=B&K|na&(B|K),Kb=2400959708):(Ja=B^K^na,Kb=3395469782);Ja=((p<<5|p>>>27)&4294967295)+Ja+Oc+Kb+v[r]&4294967295;Oc=na;na=K;K=(B<<30|B>>>2)&4294967295;B=p;p=Ja}e[0]=e[0]+p&4294967295;e[1]=
...
;function Sc(a){var b=Nc(String(x.location.href)),c;(c=x.__SAPISID||x.__APISID||x.__OVERRIDE_SID)?c=!0:(c=new oc(document),c=c.get("SAPISID")||c.get("APISID")||c.get("__Secure-3PAPISID")||c.get("SID"),c=!!c);if(c&&(c=(b=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?x.__SAPISID:x.__APISID,c||(c=new oc(document),c=c.get(b?"SAPISID":"APISID")||c.get("__Secure-3PAPISID")),c)){b=b?"SAPISIDHASH":"APISIDHASH";var d=String(x.location.href);return d&&c&&b?[b,Qc(Nc(d),c,a||null)].join(" "):null}return null}
...
function ef(a,b){if(!qe("web_use_beacon_api_for_ad_click_server_pings"))return!1;if(qe("use_sonic_library_for_v4_support"))try{var c,d=I(J(5,a));if(!(c=!(d&&d.endsWith("/aclk")))){var e=new Wb({url:a});c=!(e.j?e.h&&e.f||e.i:e.g)}if(c)return!1}catch(f){return ve(Error("ClickUrl library throws error, url = "+a)),!1}else if(c=I(J(5,a)),!c||-1==c.indexOf("/aclk")||"1"!==Vb(a,"ae")||"1"!==Vb(a,"act"))return!1;return gf(a)?(b&&b(),!0):!1}
...
function lg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.ob||Q("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().nb:b=Sc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
n.loadNewVideoConfig=function(a){if(!this.g){this.T&&(T(this.T),this.T=0);a instanceof Nh||(a=new Nh(a));this.ca=a;this.f=a.clone();Wh(this);this.W||(this.W=Yh(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=Lc(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=Lc(Number(a)||a);Xh(this);this.w&&Zh(this)}};
...
Li={},Mi=(Li.ccs="CANARY_STATE_",Li.mver="MEASUREMENT_VERSION_",Li.pis="PLAYER_INITIALIZED_STATE_",Li.yt_pt="LATENCY_PLAYER_",Li.pa="LATENCY_ACTION_",Li.yt_vst="VIDEO_STREAM_TYPE_",Li),Ni="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
...
;function Zi(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);Ic(this,Ka(Jc,this.f))}
...
n.dispose=function(){hj.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function lj(a,b,c){M.call(this);this.f=a;this.i=c;this.j=W(window,"message",A(this.l,this));this.h=new $i(this,a,b);Ic(this,Ka(Jc,this.h))}
...
null):f.loadNewVideoConfig(a):(f=new Uh(b,e,a,void 0),ii[e]=f,pf("player-added",f.api),Ic(f,Ka(ki,f)));a=f.api;Ej=a;a.addEventListener("onScreenChanged",Jj);a.addEventListener("onLogClientVeCreated",Ij);a.addEventListener("onLogServerVeCreated",Kj);a.addEventListener("onLogVeClicked",Lj);a.addEventListener("onLogVesShown",Mj);d=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?Gj=new kj(a):Q("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(Fj=new lj(window.parent,d,c),Gj=new fj(a,Fj.h));
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Yg.dispose();a=0;for(var b=Sg.length;a<b;a++){var c=Sg[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):T(c)}}Sg.length=0;Qg("//static.doubleclick.net/instream/ad_status.js");Tg=!1;P("DCLKSTAT",0);Kc(Gj,Fj);if(a=Ej)a.removeEventListener("onScreenChanged",Jj),a.removeEventListener("onLogClientVeCreated",Ij),a.removeEventListener("onLogServerVeCreated",Kj),a.removeEventListener("onLogVeClicked",Lj),a.removeEventListener("onLogVesShown",
Mj),a.destroy();Hj={}});
